...
<tileset version="1.10" tiledversion="1.11.2" name="column_trap" tilewidth="16" tileheight="16" tilecount="72" columns="18">
 <image source="column_trap.png" width="288" height="64"/>
 <tile id="0">
  <animation>
