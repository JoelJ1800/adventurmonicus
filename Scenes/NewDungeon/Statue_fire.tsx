...
<tileset version="1.10" tiledversion="1.11.2" name="Statue_fire" tilewidth="16" tileheight="16" tilecount="150" columns="30">
 <image source="Statue_fire.png" width="480" height="80"/>
 <tile id="0">
  <animation>
