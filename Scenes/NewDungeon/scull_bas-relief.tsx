...
<tileset version="1.10" tiledversion="1.11.2" name="scull_bas-relief" tilewidth="16" tileheight="16" tilecount="48" columns="4">
 <image source="scull_bas-relief.png" width="64" height="192"/>
 <tile id="0">
  <animation>
